...
from nem_rates.config import VINTAGE_BY_YEAR
...
class NemRatesConfigFlow(ConfigFlow, domain=DOMAIN):
    VERSION = 1
    ...
    def async_get_options_flow(entry: ConfigEntry) -> OptionsFlow:
        return NemRatesOptionsFlow()


class NemRatesOptionsFlow(OptionsFlow):
